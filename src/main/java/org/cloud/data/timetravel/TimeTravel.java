...
public class TimeTravel {
    public static void main(String[] args) throws NoSuchTableException {
        ...
        spark.sql("select * from local.uber.trips.history").show();
        spark.sql("select * from local.uber.trips").show(); //
        spark.sql("select * from local.uber.trips VERSION AS OF 8203583754746805072").show();
