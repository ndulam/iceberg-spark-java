...
public class Expiresnapshotfiles {
    public static void main(String[] args) throws NoSuchTableException {
        ...
        TableIdentifier tableIdentifier = TableIdentifier.of( "uber","trips");
        //catalog.listTables(Namespace.of("db")).get(0);

        long tsToExpire = System.currentTimeMillis() - (1000 * 60*5 ); // 5 minutes
